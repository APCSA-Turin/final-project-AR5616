...
public class API {
    ...
    private static final ArrayList<String> PLAYER_IDS;
        ...
        PLAYER_NAMES = new ArrayList<>(Arrays.asList("Trae Young", "Dejounte Murray", "Saddiq Bey", "Jalen Johnson", "Clint Capela", "Bogdan Bogdanovic", "Jayson Tatum", "Jaylen Brown", "Kristaps Porzingis", "Derrick White", "Jrue Holiday", "Sam Hauser", "Mikal Bridges", "Cameron Johnson", "Nic Claxton", "Spencer Dinwiddie", "Ben Simmons", "Dorian Finney-Smith", "LaMelo Ball", "Brandon Miller", "Ish Smith", "Gordon Hayward", "PJ Washington", "Nick Richards", "DeMar DeRozan", "Zach LaVine", "Coby White", "Alex Caruso", "Nikola Vucevic", "Patrick Williams", "Donovan Mitchell", "Darius Garland", "Max Strus", "Georges Niang", "Jarrett Allen", "Caris LeVert", "Luka Doncic", "Kyrie Irving", "Tim Hardaway Jr.", "Derrick Jones Jr.", "Daniel Gafford", "Maxi Kleber", "Jamal Murray", "Nikola Jokic", "Michael Porter Jr.", "Aaron Gordon", "Kentavious Caldwell-Pope", "Reggie Jackson", "Cade Cunningham", "Jaden Ivey", "Ausar Thompson", "Bojan Bogdanovic", "Isaiah Stewart", "Jalen Duren", "Stephen Curry", "Klay Thompson", "Draymond Green", "Andrew Wiggins", "Chris Paul", "Jonathan Kuminga", "Fred VanVleet", "Alperen Sengun", "Jabari Smith Jr.", "Dillon Brooks", "Jalen Green", "Cam Whitmore", "Tyrese Haliburton", "Pascal Siakam", "Bennedict Mathurin", "Myles Turner", "Bruce Brown", "Buddy Hield", "James Harden", "Kawhi Leonard", "Paul George", "Russell Westbrook", "Ivica Zubac", "Norman Powell", "LeBron James", "Gabe Vincent", "DAngelo Russell", "Austin Reaves", "Rui Hachimura", "Christian Wood", "Ja Morant", "Marcus Smart", "Desmond Bane", "Jaren Jackson Jr.", "Santi Aldama", "Luke Kennard", "Jimmy Butler", "Bam Adebayo", "Tyler Herro", "Terry Rozier", "Duncan Robinson", "Kevin Love", "Damian Lillard", "Giannis Antetokounmpo", "Khris Middleton", "Brook Lopez", "Bobby Portis", "Malik Beasley", "Anthony Edwards", "Karl-Anthony Towns", "Rudy Gobert", "Jaden McDaniels", "Mike Conley", "Naz Reid", "Zion Williamson", "Brandon Ingram", "CJ McCollum", "Jonas Valanciunas", "Herbert Jones", "Trey Murphy III", "Jalen Brunson", "Julius Randle", "OG Anunoby", "RJ Barrett", "Josh Hart", "Mitchell Robinson", "Shai Gilgeous-Alexander", "Chet Holmgren", "Jalen Williams", "Josh Giddey", "Lu Dort", "Isaiah Joe", "Paolo Banchero", "Franz Wagner", "Cole Anthony", "Jalen Suggs", "Wendell Carter Jr.", "Joe Ingles", "Joel Embiid", "Tyrese Maxey", "Tobias Harris", "Kelly Oubre Jr.", "Buddy Hield", "Kyle Lowry", "Kevin Durant", "Devin Booker", "Bradley Beal", "Jusuf Nurkic", "Grayson Allen", "Eric Gordon", "Anfernee Simons", "Jerami Grant", "Deandre Ayton", "Scoot Henderson", "Shaedon Sharpe", "Malcolm Brogdon", "De'Aaron Fox", "Domantas Sabonis", "Keegan Murray", "Kevin Huerter", "Malik Monk", "Harrison Barnes", "Victor Wembanyama", "Devin Vassell", "Julian CHampagnie", "Jeremy Sochan", "Tre Jones", "Zach Collins", "Scottie Barnes", "Pascal Siakam", "Dennis Schroder", "Jakob Poeltl", "Gary Trent Jr.", "Immanuel Quickley", "Lauri Markkanen", "John Collins", "Jordan Clarkson", "Collin Sexton", "Walker Kessler", "Talen Horton-Tucker", "Kyle Kuzma", "Jordan Poole", "Tyus Jones", "Deni Avdija", "Daniel Gafford", "Corey Kispert"));
